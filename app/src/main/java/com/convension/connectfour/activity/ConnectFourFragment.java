  ...
  //  private BottomView mBottomView;
    ...
    private void startGame(){
       ...
       // int p = settings.getInt(Connect4App.PREFS_PLAY, Players.ONE_PLAYER);
        ...
        mGameView.setMtopView(mtopView);
    ...
    private void store(){
        SharedPreferences settings = getActivity().getSharedPreferences(Connect4App.PREFS_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.putInt(Connect4App.PREFS_DIFF,Players.DIFF_EASY);
        editor.putInt(Connect4App.PREFS_POWER,Players.POWER_OFF);
