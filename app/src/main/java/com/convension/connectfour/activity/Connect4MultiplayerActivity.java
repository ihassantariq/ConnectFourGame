...
public class Connect4MultiplayerActivity extends ABaseActivity
    ...
    // invitation listener
    private ConnectFourFragment mMultiplayerFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_four_multiplayer);
        Players.IS_MULTIPLAYER_SERVER=true;
    ...
    public void onLeftRoom(int statusCode, String roomId) {
      ...
      //  switchToMainScreen ();
        ...
        Snackbar snackbar = Snackbar
                .make(findViewById (R.id.root_view), "You just left the room !", Snackbar.LENGTH_LONG)
...
// Changing message text color
    ...
    public void onRealTimeMessageReceived(RealTimeMessage rtm) {
        ...
        if (buf[0] == 'F' || buf[0] == 'U') {
            ...
            mMultiplayerFragment.onMessageReceived (thisScore,false);
